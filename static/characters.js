...
function rendermpt(){
    let b = []
    if (lastelmarr.length >= 100){lastelmarr=[]}
...
// these two function is used to get id of the button that user clicked on (2023/02/06)
function getleftclicked(id){
    if (listofclickedbutton.includes(id)){return}
    if(clickedright>8){
...
function checkmatch(){
    ...
    if(romanjiarr[jpchrbase.indexOf(a)]==b){
    ...
    listofclickedbutton.push(clickedleft)
    listofclickedbutton.push(clickedright)
    clickedleft=0
    clickedright=9
    counting++
    numofallans++
...
// this function is use to render true ans
function  render_true_ans(){
    
    
    for (let i = 1; i < 9; i++) {
    document.getElementById(String(i)+String(i)).className = 'ansdivfinal'
    }
    document.getElementById('5').innerHTML = romanjiarr[jpchrbase.indexOf(document.getElementById('1').innerHTML)]
    document.getElementById('6').innerHTML = romanjiarr[jpchrbase.indexOf(document.getElementById('2').innerHTML)]
    document.getElementById('7').innerHTML = romanjiarr[jpchrbase.indexOf(document.getElementById('3').innerHTML)]
    document.getElementById('8').innerHTML = romanjiarr[jpchrbase.indexOf(document.getElementById('4').innerHTML)]
}
